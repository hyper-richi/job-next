...
export default async function VacancyCard({
  regionCode,
  vacancy,
  offset,
  searchText,
    ...
    <div className={styles.vacancy}>
      ...
      <Link className={styles.vacancy__link} href={url} target='_blank'>
        <h6 className={styles.vacancy__title}>
          {vacancyName.charAt(0).toUpperCase() + vacancyName.slice(1)}
        </h6>
        <div className={styles.vacancy__info}>
          ...
          <span className={styles.vacancy__info__specialisation}>
