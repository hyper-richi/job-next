...
export const Vacancy = (): JSX.Element => {
    return (
        <div className={styles.vacancy}>
            <div className={styles.vacancy__hr}></div>
            <div className="">
                <Link className={styles.vacancy__link} href="/" target="_blank">
                    <h6 className={styles.vacancy__title}>Android разработчик, Департамент разработки Фреш</h6>
                    <div className={styles.vacancy__wrp}>
                        <div className={styles.vacancy__info}>
                            ...
                            <span className="">Город Москва</span>
                            <span className=""> · </span>
                            <span className={styles.vacancy__salary}>90000-90000 ₽ </span>
                            <span className="">Информационные технологии, телекоммуникации, связь</span>
                        </div>
                    </div>
                    <span className={styles.vacancy__arrow}>
                        <svg width="9" height="16" viewBox="0 0 9 16" fill="none" xmlns="http://www.w3.org/2000/svg" className="arrow">
                            <path
